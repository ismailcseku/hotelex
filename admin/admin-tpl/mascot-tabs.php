...
<?php
$links = array(
	'mascot-about'			  	=> esc_html__( 'About', 'hotelex' ),
	'mascot-docs' 				=> esc_html__( 'Support & Help', 'hotelex' ),
	'mascot-faq' 				=> esc_html__( 'FAQ', 'hotelex' ),
	'mascot-system-status'     	=> esc_html__( 'System Status', 'hotelex' ),
);
