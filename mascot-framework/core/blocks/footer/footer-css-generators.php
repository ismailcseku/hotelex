...
if (!function_exists('hotelex_get_footer_parts_wpb_shortcodes_custom_css')) {
	/**
	 * Add VC inline css to body
	 */
	function hotelex_get_footer_parts_wpb_shortcodes_custom_css() {
		...
		if( ! hotelex_metabox_opt_val_is_empty( $temp_meta_value ) && $temp_meta_value != "inherit" ) {
			...
			$params['footer_widget_area'] = hotelex_get_redux_option( 'footer-settings-choose-footer-widget-area', 'default' );
		}
	...
	add_action( 'wp_enqueue_scripts', 'hotelex_get_footer_parts_wpb_shortcodes_custom_css' );
}



if (!function_exists('hotelex_footer_bottom_background_color')) {
	/**
	 * Generate CSS codes for Footer Bottom Background Color
	 */
	function hotelex_footer_bottom_background_color() {
		...
		echo hotelex_dynamic_css_generator($selector, $declaration);
	}
	add_action('hotelex_dynamic_css_generator_action', 'hotelex_footer_bottom_background_color');
}




if (!function_exists('hotelex_footer_widget_title_line_bottom_color')) {
	/**
	 * Generate CSS codes for Footer Top Widget Title Custom Line Bottom Color
	 */
	function hotelex_footer_widget_title_line_bottom_color() {
		global $hotelex_redux_theme_opt;
		$var_name = 'footer-settings-footer-widget-title-line-bottom-custom-color';
		//If Make Line Bottom Theme Colored?
		if( $hotelex_redux_theme_opt['footer-settings-footer-widget-title-line-bottom-theme-colored'] != '' ) {
			return;
		}
	...
	add_action('hotelex_dynamic_css_generator_action', 'hotelex_footer_widget_title_line_bottom_color');
}
...
if (!function_exists('hotelex_footer_widget_title_typography')) {
	/**
	 * Generate CSS codes for Footer Top Widget Title Typography
	 */
	function hotelex_footer_widget_title_typography() {
		global $hotelex_redux_theme_opt;
	...
	add_action('hotelex_dynamic_css_generator_action', 'hotelex_footer_widget_title_typography');
}

if (!function_exists('hotelex_footer_widget_text_typography')) {
	/**
	 * Generate CSS codes for Footer Top Widget Text Typography
	 */
	function hotelex_footer_widget_text_typography() {
		global $hotelex_redux_theme_opt;
	...
	add_action('hotelex_dynamic_css_generator_action', 'hotelex_footer_widget_text_typography');
}

if (!function_exists('hotelex_footer_widget_link_typography')) {
	/**
	 * Generate CSS codes for Footer Top Widget Link Typography
	 */
	function hotelex_footer_widget_link_typography() {
		global $hotelex_redux_theme_opt;
	...
	add_action('hotelex_dynamic_css_generator_action', 'hotelex_footer_widget_link_typography');
}

if (!function_exists('hotelex_footer_widget_link_hover_color')) {
	/**
	 * Generate CSS codes for Footer Top Widget Link Hover Color
	 */
	function hotelex_footer_widget_link_hover_color() {
		global $hotelex_redux_theme_opt;
	...
	add_action('hotelex_dynamic_css_generator_action', 'hotelex_footer_widget_link_hover_color');
}