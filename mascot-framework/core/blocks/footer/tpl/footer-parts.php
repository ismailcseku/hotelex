	...
	<?php
	/**
	* hotelex_before_footer hook.
	*
	*/
	do_action( 'hotelex_before_footer' );
	?>
	<footer id="footer" class="footer <?php echo esc_attr( $footer_classes );?>">
	<?php
		/**
		* hotelex_footer_start hook.
		*
		*/
		do_action( 'hotelex_footer_start' );
	?>
		<div class="footer-widget-area">
			<?php if ( isset($footer_widget_area) && !empty($footer_widget_area) && mascot_core_hotelex_plugin_installed() ) { ?>
	...
	<?php
		/**
		* hotelex_footer_end hook.
		*
		*/
		do_action( 'hotelex_footer_end' );
	?>
	</footer>
	<?php
	/**
	* hotelex_after_footer hook.
	*
	*/
	do_action( 'hotelex_after_footer' );
	?>