...
add_action( 'hotelex_nav_megamenu_item_custom_fields', 'hotelex_add_megamenu_fields', 20, 4 );
 ...
 */
function hotelex_add_megamenu_fields( $item_id, $item, $depth, $args ) {
	?>
	<div class="clear"></div>
	<div class="mascot-mega-menu-options">
		<p class="field-megamenu-status description description-wide">
			<label for="edit-menu-item-mascot-megamenu-status-<?php echo esc_attr( $item_id ); ?>">
				...
				<strong><?php esc_html_e( 'Enable Mega Menu (only for main menu)', 'hotelex' ); ?></strong>
			</label>
		</p>
		<p class="field-megamenu-containerwidth description description-wide">
			<label for="edit-menu-item-mascot-megamenu-containerwidth-<?php echo esc_attr( $item_id ); ?>">
				<?php esc_html_e( 'Mega Menu Container Width', 'hotelex' ); ?>
				<select id="edit-menu-item-mascot-megamenu-containerwidth-<?php echo esc_attr( $item_id ); ?>" class="widefat code edit-menu-item-mascot-megamenu-containerwidth" name="menu-item-mascot-megamenu-containerwidth[<?php echo esc_attr( $item_id ); ?>]">
					<option value="megamenu-fullwidth-fullwindow" <?php selected( $item->mascot_megamenu_containerwidth, 'megamenu-fullwidth-fullwindow' ); ?>><?php esc_html_e( 'Fullwidth - Full Window', 'hotelex' ); ?></option>
					<option value="megamenu-fullwidth" <?php selected( $item->mascot_megamenu_containerwidth, 'megamenu-fullwidth' ); ?>><?php esc_html_e( 'Fullwidth', 'hotelex' ); ?></option>
					<option value="megamenu-three-quarter-width" <?php selected( $item->mascot_megamenu_containerwidth, 'megamenu-three-quarter-width' ); ?>><?php esc_html_e( 'Three Quarter Width', 'hotelex' ); ?></option>
					<option value="megamenu-half-width" <?php selected( $item->mascot_megamenu_containerwidth, 'megamenu-half-width' ); ?>><?php esc_html_e( 'Half Width', 'hotelex' ); ?></option>
					<option value="megamenu-quarter-width" <?php selected( $item->mascot_megamenu_containerwidth, 'megamenu-quarter-width' ); ?>><?php esc_html_e( 'Quarter Width', 'hotelex' ); ?></option>
				</select>
			</label>
		</p>
		<p class="field-megamenu-dropdownposition description description-wide">
			<label for="edit-menu-item-mascot-megamenu-dropdownposition-<?php echo esc_attr( $item_id ); ?>">
				<?php esc_html_e( 'Mega Menu Dropdown Position', 'hotelex' ); ?>
				<select id="edit-menu-item-mascot-megamenu-dropdownposition-<?php echo esc_attr( $item_id ); ?>" class="widefat code edit-menu-item-mascot-megamenu-dropdownposition" name="menu-item-mascot-megamenu-dropdownposition[<?php echo esc_attr( $item_id ); ?>]">
					<option value="megamenu-position-left" <?php selected( $item->mascot_megamenu_dropdownposition, 'megamenu-position-left' ); ?>><?php esc_html_e( 'Left', 'hotelex' ); ?></option>
					<option value="megamenu-position-center" <?php selected( $item->mascot_megamenu_dropdownposition, 'megamenu-position-center' ); ?>><?php esc_html_e( 'Center', 'hotelex' ); ?></option>
					<option value="megamenu-position-right" <?php selected( $item->mascot_megamenu_dropdownposition, 'megamenu-position-right' ); ?>><?php esc_html_e( 'Right', 'hotelex' ); ?></option>
				</select>
			</label>
		</p>
		<p class="field-megamenu-gridcolumnwidth description description-wide">
			<label for="edit-menu-item-mascot-megamenu-gridcolumnwidth-<?php echo esc_attr( $item_id ); ?>">
				<?php esc_html_e( 'Mega Menu Column Width in Grid system', 'hotelex' ); ?>
				<select id="edit-menu-item-mascot-megamenu-gridcolumnwidth-<?php echo esc_attr( $item_id ); ?>" class="widefat code edit-menu-item-mascot-megamenu-gridcolumnwidth" name="menu-item-mascot-megamenu-gridcolumnwidth[<?php echo esc_attr( $item_id ); ?>]">
					<option value="" <?php selected( $item->mascot_megamenu_gridcolumnwidth, 'auto' ); ?>><?php esc_html_e( 'Auto', 'hotelex' ); ?></option>
		...
		<p class="field-megamenu-cpt description description-wide">
			<label for="edit-menu-item-mascot-megamenu-cpt-<?php echo esc_attr( $item_id ); ?>">
				<?php esc_html_e( 'Mega Menu Elementor (Optional)', 'hotelex' ); ?>
					<?php
						...
						$tg_megamenu_select[''] = esc_html__( '-- Select Megamenu --', 'hotelex' );
						...
						{
							$tg_megamenu_select[''] = esc_html__( 'No mega menu found. Please create one first', 'hotelex' );
						}
					?>
		...
		<p class="field-megamenu-widgetarea description description-wide">
			<label for="edit-menu-item-mascot-megamenu-widgetarea-<?php echo esc_attr( $item_id ); ?>">
				<?php esc_html_e( 'Mega Menu Widget Area (Optional)', 'hotelex' ); ?>
				<select id="edit-menu-item-mascot-megamenu-widgetarea-<?php echo esc_attr( $item_id ); ?>" class="widefat code edit-menu-item-mascot-megamenu-widgetarea" name="menu-item-mascot-megamenu-widgetarea[<?php echo esc_attr( $item_id ); ?>]">
					<option value="0"><?php esc_html_e( 'Select Widget Area', 'hotelex' ); ?></option>
		...
		<p class="field-megamenu-bgimage description description-wide">
			<a  id="mascot-media-upload-<?php echo esc_attr( $item_id ); ?>" class="mascot-open-media button button-primary mascot-megamenu-upload-bgimage" data-target="#edit-menu-item-mascot-megamenu-bgimage-<?php echo esc_attr( $item_id ); ?>" data-preview=".mascot-megamenu-bgimage-image" data-frame="select" data-state="wpc_widgets_insert_single" data-fetch="url" data-title="<?php esc_attr_e( 'Insert Image', 'hotelex' ); ?>" data-button="<?php esc_attr_e( 'Insert', 'hotelex' ); ?>" data-class="media-frame tm-widget-custom-uploader" title="<?php esc_attr_e( 'Add Media', 'hotelex' ); ?>"><?php esc_html_e( 'Set BG image', 'hotelex' ); ?></a>
...
if( !class_exists( 'Hotelex_Walker_Nav_Menu_Edit_Custom' ) ) {
class Hotelex_Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
	/**
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
		...
		if ( ! empty( $menu_item->_invalid ) ) {
			...
			$title = sprintf( __( '%s (Invalid)', 'hotelex' ), $menu_item->title );
		} elseif ( isset( $menu_item->post_status ) && 'draft' === $menu_item->post_status ) {
			$classes[] = 'pending';
			/* translators: %s: Title of a menu item in draft status. */
			$title = sprintf( __( '%s (Pending)', 'hotelex' ), $menu_item->title );
		}
			...
			<div class="menu-item-bar">
				<div class="menu-item-handle">
					<label class="item-title" for="menu-item-checkbox-<?php echo esc_attr( $item_id ); ?>">
						...
						<span class="is-submenu" <?php echo esc_attr( $submenu_text ); ?>><?php _e( 'sub item', 'hotelex' ); ?></span>
					</label>
					<span class="item-controls">
						...
						printf(
							...
							$item_id,
							$edit_url,
							esc_attr__( 'Edit menu item', 'hotelex' ),
							__( 'Edit', 'hotelex' )
						);
						?>
					</span>
			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo esc_attr( $item_id ); ?>">
				...
				<p class="description description-wide">
					<label for="edit-menu-item-title-<?php echo esc_attr( $item_id ); ?>">
						<?php _e( 'Navigation Label', 'hotelex' ); ?><br />
				...
				<p class="field-title-attribute field-attr-title description description-wide">
					<label for="edit-menu-item-attr-title-<?php echo esc_attr( $item_id ); ?>">
						<?php _e( 'Title Attribute', 'hotelex' ); ?><br />
				...
				<p class="field-link-target description">
					<label for="edit-menu-item-target-<?php echo esc_attr( $item_id ); ?>">
						...
						<?php _e( 'Open link in a new tab', 'hotelex' ); ?>
					</label>
				</p>
				<p class="field-css-classes description description-thin">
					<label for="edit-menu-item-classes-<?php echo esc_attr( $item_id ); ?>">
						<?php _e( 'CSS Classes (optional)', 'hotelex' ); ?><br />
				...
				<p class="field-xfn description description-thin">
					<label for="edit-menu-item-xfn-<?php echo esc_attr( $item_id ); ?>">
						<?php _e( 'Link Relationship (XFN)', 'hotelex' ); ?><br />
				...
				<p class="field-description description description-wide">
					<label for="edit-menu-item-description-<?php echo esc_attr( $item_id ); ?>">
						...
						<span class="description"><?php _e( 'The description will be displayed in the menu if the active theme supports it.', 'hotelex' ); ?></span>
					</label>
				</p>
				...
				<p class="field-megamenu-title description description-wide">
					<label for="edit-menu-item-mascot-submenu-title-<?php echo esc_attr( $item_id ); ?>">
						...
						<strong><?php esc_html_e( 'Show this Navigation Label as a Bold Title', 'hotelex' ); ?></strong>
					</label>
				</p>
				<p class="field-dropdownposition description description-wide">
					<label for="edit-menu-item-mascot-dropdownposition-<?php echo esc_attr( $item_id ); ?>">
						...
						<?php esc_html_e( 'Show it\'s dropdown items to left (default right)', 'hotelex' ); ?>
					</label>
				</p>
				<p class="field-custom description description-wide">
					<label for="edit-menu-item-mascot-subtitle-<?php echo esc_attr( $item_id ); ?>">
					<?php esc_html_e( 'Subtitle', 'hotelex' ); ?>
					<br />
				...
				<p class="description description-wide">
					<label for="edit-menu-item-mascot-menuicon-<?php echo esc_attr($item_id); ?>">
						<?php esc_html_e('Icon', 'hotelex'); ?><br/>
						<select id="edit-menu-item-mascot-menuicon-<?php echo esc_attr($item_id); ?>"
							...
							<option value="" <?php selected('', esc_attr($menu_item->mascot_menuicon)) ?>><?php esc_html_e('No Icons', 'hotelex') ?></option>
				...
				<?php
					if( hotelex_get_redux_option( 'header-menu-megamenu-enable-megamenu' ) ) {
						do_action( 'hotelex_nav_megamenu_item_custom_fields', $item_id, $menu_item, $depth, $args );
					}
				?>
				<?php
				...
				<fieldset class="field-move hide-if-no-js description description-wide">
					<span class="field-move-visual-label" aria-hidden="true"><?php _e( 'Move', 'hotelex' ); ?></span>
					<button type="button" class="button-link menus-move menus-move-up" data-dir="up"><?php _e( 'Up one', 'hotelex' ); ?></button>
					<button type="button" class="button-link menus-move menus-move-down" data-dir="down"><?php _e( 'Down one', 'hotelex' ); ?></button>
					<button type="button" class="button-link menus-move menus-move-left" data-dir="left"></button>
					<button type="button" class="button-link menus-move menus-move-right" data-dir="right"></button>
					<button type="button" class="button-link menus-move menus-move-top" data-dir="top"><?php _e( 'To the top', 'hotelex' ); ?></button>
				</fieldset>
