...
if( !class_exists( 'Hotelex_RC_Sweet_Custom_Menu' ) ) {
class Hotelex_RC_Sweet_Custom_Menu {
    ...
    {
        wp_enqueue_style('jquery.fonticonpicker.min.css', HOTELEX_TEMPLATE_URI . '/assets/js/plugins/iconpicker/css/jquery.fonticonpicker.min.css', array(), 'all');
        wp_enqueue_style('jquery.fonticonpicker.grey.min.css', HOTELEX_TEMPLATE_URI . '/assets/js/plugins/iconpicker/themes/grey-theme/jquery.fonticonpicker.grey.min.css', array(), 'all');
        wp_enqueue_script('jquery.fonticonpicker.js', HOTELEX_TEMPLATE_URI . '/assets/js/plugins/iconpicker/jquery.fonticonpicker.js', array('jquery'));
    }
	...
	*/
	function rc_scm_add_custom_nav_fields( $menu_item ) {
		...
		if( hotelex_get_redux_option( 'header-menu-megamenu-enable-megamenu' ) == 1 ) {
	...
	*/
	function rc_scm_edit_walker($walker,$menu_id) {
		...
		return 'Hotelex_Walker_Nav_Menu_Edit_Custom';
...
$GLOBALS['sweet_custom_menu'] = new Hotelex_RC_Sweet_Custom_Menu();
