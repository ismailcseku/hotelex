 ...
 */
require_once HOTELEX_FRAMEWORK_DIR . '/tgm/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'hotelex_register_required_plugins' );
 ...
 */
function hotelex_register_required_plugins() {
	$plugins_path = HOTELEX_FRAMEWORK_DIR . '/tgm/plugins';
	...
	$plugins = array(
		array(
			'name'         	=> 'Mascot Core - Hotelex',
			'slug'         	=> 'mascot-core-hotelex',
			'source'       	=> $server_path . 'mascot-core-elementor/mascot-core-hotelex.zip',
			'required'     	=> true,
			'version'      	=> '1.0'
		),
		array(
	 ...
	 */
	$config = array(
		'id'           => 'hotelex',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'message'      => '<div class="notice notice-info is-dismissible mt-20">
			...
			<p><strong>Note from Author ' . HOTELEX_AUTHOR . ':</strong> To ensure the latest version of <em>theme required</em> plugins, you must have the latest version of <strong>' . $theme_name . '</strong></p>
